...
alphas = np.arange(0.2, 0.00, -0.001)
...
print(generate_from_LM(en_opt_add_alpha_dist, 300))
print(generate_from_LM(es_opt_add_alpha_dist, 300))
print(generate_from_LM(de_opt_add_alpha_dist, 300))
